...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
                  ...
                  child:Column(
                    ...
                    children:[
                      Container(
                        ...
                        child: Column(
                          children:[
                            Text("Create A New Password",style: Theme.of(context).textTheme.headline5,),
                            SizedBox(height:20),
                            Text("Set your new password so you can login and access Little Cake Story",
                        ...
                        child: Column(
                          children:[
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(fontSize: 18,fontFamily: 'Calibri'),
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon:GestureDetector(
                                  ...
                                  child: Icon(
                                    hiddenPassword3 ? Icons.visibility_off : Icons.visibility))
                              ),
  ...
  void _onReset() {
    ...
    if(_currentPassword.isEmpty && _newPassword.isEmpty && _confirmPassword.isEmpty){
      ...
      Fluttertoast.showToast(
        ...
        fontSize: 16.0);
      return;
    }else if( _newPassword!=_confirmPassword || _confirmPassword!=_newPassword){
      Fluttertoast.showToast(
      ...
      Fluttertoast.showToast(
        ...
        fontSize: 16.0);
      return;
    }else if( _newPassword==widget.user.password || _confirmPassword==widget.user.password){
      Fluttertoast.showToast(
  ...
  void _resetPassword(String newpassword,String email){
    ...
    http.post(
      Uri.parse("https://javathree99.com/s271059/littlecakestory/php/user_password/resetpassword_user.php"),
      body: {
        "email":email,
