...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(
        title:Text("Privacy Policy",style: TextStyle(fontFamily: 'Arial',color: Colors.white)),
      ),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Privacy Policy for Little Cake Story",
                    style: Theme.of(context).textTheme.headline6,
                  ),
                  SizedBox(height:20),
                  Text("At Little Cake Story, accessible from www.littlecakestory.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Little Cake Story and how we use it.",
                  ...
                  SizedBox(height:20),
                  Text("This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Little Cake Story. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Online Generator of Privacy Policy.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  Text("Consent",
                  ...
                  SizedBox(height:20),
                  Text("For more general information on cookies, please read 'What Are Cookies' from Cookie Consent.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  ...
                  SizedBox(height:20),
                  Text("You may consult this list to find the Privacy Policy for each of the advertising partners of Little Cake Story.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  Text("Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Little Cake Story, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  Text("Note that Little Cake Story has no access to or control over these cookies that are used by third-party advertisers.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  ...
                  SizedBox(height:20),
                  Text("Little Cake Story's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                  SizedBox(height:20),
                  ...
                  SizedBox(height:20),
                  Text("Little Cake Story does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.",
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                ],
              ),
