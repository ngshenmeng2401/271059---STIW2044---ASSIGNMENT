...
class AddTartScreen extends StatefulWidget {
  ...
  final User user;
  const AddTartScreen({Key key, this.user}) : super(key: key);

  @override
  _AddTartScreenState createState() => _AddTartScreenState();
}

class _AddTartScreenState extends State<AddTartScreen> {
