...
class MyBentoCakeListScreen extends StatefulWidget {
  ...
  const MyBentoCakeListScreen({Key key,this.user, this.productList}):super(key: key);
...
class _MyBentoCakeListScreenState extends State<MyBentoCakeListScreen> {
  ...
  void _loadMyBentoCake() {
    ...
    http.post(
      Uri.parse("https://javathree99.com/s271059/littlecakestory/php/load_my_other_product.php"),
      body: {
  ...
  void _bentoCakeDetails(int index) {
    ...
    Navigator.pushReplacement(
      context,MaterialPageRoute(builder: (context)=> MyBentoCakeDetails(productList:productList,user: widget.user,))
    );
  }
}